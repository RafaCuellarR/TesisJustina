...
\begin{minipage}[t]{20cm}
  \includegraphics[height=3.0cm]{img/escudounam_negro.jpg}
  \hspace{0.5cm}
...
\begin{minipage}[t]{4cm}
  \includegraphics[height=3.2cm]{img/escudofi_negro.jpg}
\end{minipage}
\hspace{5cm}
...
\input{secs/introduccion}

% -------- BACKGROUND
\chapter{Antecedentes}
\input{secs/antecedentes}

% -------- METHODOLOGY
\chapter{Metodolog\'ia}
\input{secs/metodologia}

\appendix

\chapter{Justina}
\input{appendix/justina}

\chapter{Protocolo de investigaci\'on}
\input{appendix/protocolo}

\chapter{Carta de consentimiento informado}
\input{appendix/consentimiento}

\bibliographystyle{ieeetr}
\bibliography{bib/introduccion, bib/antecedentes, bib/metodologia}
