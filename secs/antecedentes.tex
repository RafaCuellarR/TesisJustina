...
% Robótica
Para hablar de manipuladores robóticos, es necesario definir la cadena cinemática. Una \textbf{cadena cinemática} es un conjunto de eslabones, conectados por pares cinemáticos, que producen movimientos relativos sincronizados con un propósito determinado. Los \textbf{pares cinemáticos}, a su vez, son el par de eslabones que tienen movimiento relativo entre sí.
